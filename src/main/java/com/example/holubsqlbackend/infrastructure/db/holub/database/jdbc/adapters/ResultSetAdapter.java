 ...
 *    in any of this code.
 */
package com.example.holubsqlbackend.infrastructure.db.holub.database.jdbc.adapters;
import java.sql.*;
 ...
 */
public class ResultSetAdapter implements ResultSet {public ResultSetAdapter() {}
...
public Time getTime(int columnIndex) throws SQLException{throw new SQLException("ResultSet.getTime(int columnIndex) unsupported");}
public Time getTime(String columnName) throws SQLException{throw new SQLException("ResultSet.getTime(String columnName) unsupported");}
public Time getTime(int columnIndex, java.util.Calendar cal) throws SQLException{throw new SQLException("ResultSet.getTime(int columnIndex, java.util.Calendar cal) unsupported");}
public Time getTime(String columnName, java.util.Calendar cal) throws SQLException{throw new SQLException("ResultSet.getTime(String columnName, java.util.Calendar cal) unsupported");}
public Timestamp getTimestamp(String columnName) throws SQLException{throw new SQLException("ResultSet.getTimestamp(String columnName) unsupported");}
public Timestamp getTimestamp(int columnIndex) throws SQLException{throw new SQLException("ResultSet.getTimestamp(int columnIndex) unsupported");}
public Timestamp getTimestamp(String columnName, java.util.Calendar cal) throws SQLException{throw new SQLException("ResultSet.getTimestamp(String columnName, java.util.Calendar cal) unsupported");}
public Timestamp getTimestamp(int columnIndex, java.util.Calendar cal) throws SQLException{throw new SQLException("ResultSet.getTimestamp(int columnIndex, java.util.Calendar cal) unsupported");}
public Date getDate(int columnIndex) throws SQLException{throw new SQLException("ResultSet.getDate(int columnIndex) unsupported");}
public Date getDate(int columnIndex, java.util.Calendar cal) throws SQLException{throw new SQLException("ResultSet.getDate(int columnIndex, java.util.Calendar cal) unsupported");}
public Date getDate(String columnIndex, java.util.Calendar cal) throws SQLException{throw new SQLException("ResultSet.getDate(String columnIndex, java.util.Calendar cal) unsupported");}
public Date getDate(String columnName) throws SQLException{throw new SQLException("ResultSet.getDate(String columnName) unsupported");}
...
public InputStream getUnicodeStream(int columnIndex) throws SQLException{throw new SQLException("ResultSet.getUnicodeStream(int columnIndex) unsupported");}
public InputStream getUnicodeStream(String columnName) throws SQLException{throw new SQLException("ResultSet.getUnicodeStream(String columnName) unsupported");}
public InputStream getAsciiStream(String columnName) throws SQLException{throw new SQLException("ResultSet.getAsciiStream(String columnName) unsupported");}
public InputStream getAsciiStream(int columnIndex) throws SQLException{throw new SQLException("ResultSet.getAsciiStream(int columnIndex) unsupported");}
...
public InputStream getBinaryStream(int columnIndex) throws SQLException{throw new SQLException("ResultSet.getBinaryStream(int columnIndex) unsupported");}
public InputStream getBinaryStream(String columnName) throws SQLException{throw new SQLException("ResultSet.getBinaryStream(String columnName) unsupported");}
...
public Ref getRef(int columnIndex) throws SQLException{throw new SQLException("ResultSet.getRef(int columnIndex) unsupported");}
public Ref getRef(String columnIndex) throws SQLException{throw new SQLException("ResultSet.getRef(String columnIndex) unsupported");}
public Blob getBlob(int columnIndex) throws SQLException{throw new SQLException("ResultSet.getBlob(int columnIndex) unsupported");}
public Blob getBlob(String columnIndex) throws SQLException{throw new SQLException("ResultSet.getBlob(String columnIndex) unsupported");}
public Clob getClob(int columnIndex) throws SQLException{throw new SQLException("ResultSet.getClob(int columnIndex) unsupported");}
public Clob getClob(String columnIndex) throws SQLException{throw new SQLException("ResultSet.getClob(String columnIndex) unsupported");}
public Array getArray(int columnIndex) throws SQLException{throw new SQLException("ResultSet.getArray(int columnIndex) unsupported");}
public Array getArray(String columnIndex) throws SQLException{throw new SQLException("ResultSet.getArray(String columnIndex) unsupported");}
public Reader getCharacterStream(int columnIndex) throws SQLException{throw new SQLException("ResultSet.getCharacterStream(int columnIndex) unsupported");}
public Reader getCharacterStream(String columnName) throws SQLException{throw new SQLException("ResultSet.getCharacterStream(String columnName) unsupported");}
...
public void updateDate(int colIndex, Date d) throws SQLException {throw new SQLException("ResultSet.updateDate(int colIndex, java.sql.Date d) unsupported");}
public void updateTime(int colIndex, Time t) throws SQLException {throw new SQLException("ResultSet.updateTime(int colIndex, java.sql.Time t) unsupported");}
public void updateTimestamp(int colIndex, Timestamp t) throws SQLException {throw new SQLException("ResultSet.updateTimestamp(int colIndex, java.sql.Timestamp t) unsupported");}
public void updateAsciiStream(int colIndex, InputStream in, int s) throws SQLException {throw new SQLException("ResultSet.updateAsciiStream(int colIndex, java.io.InputStream in, int s) unsupported");}
public void updateBinaryStream(int colIndex, InputStream in, int s) throws SQLException {throw new SQLException("ResultSet.updateBinaryStream(int colIndex, java.io.InputStream in, int s) unsupported");}
public void updateCharacterStream(int colIndex, Reader in, int s) throws SQLException {throw new SQLException("ResultSet.updateCharacterStream(int colIndex, java.io.Reader in, int s) unsupported");}
...
public void updateDate(String colIndex, Date d) throws SQLException {throw new SQLException("ResultSet.updateDate(String colIndex, java.sql.Date d) unsupported");}
public void updateTime(String colIndex, Time t) throws SQLException {throw new SQLException("ResultSet.updateTime(String colIndex, java.sql.Time t) unsupported");}
public void updateTimestamp(String colIndex, Timestamp t) throws SQLException {throw new SQLException("ResultSet.updateTimestamp(String colIndex, java.sql.Timestamp t) unsupported");}
public void updateAsciiStream(String colIndex, InputStream in, int s) throws SQLException {throw new SQLException("ResultSet.updateAsciiStream(String colIndex, java.io.InputStream in, int s) unsupported");}
public void updateBinaryStream(String colIndex, InputStream in, int s) throws SQLException {throw new SQLException("ResultSet.updateBinaryStream(String colIndex, java.io.InputStream in, int s) unsupported");}
public void updateCharacterStream(String colIndex, Reader in, int s) throws SQLException {throw new SQLException("ResultSet.updateCharacterStream(String colIndex, java.io.Reader in, int s) unsupported");}
