 ...
 *    in any of this code.
 */
package com.example.holubsqlbackend.infrastructure.holub.database.jdbc;

import java.sql.*;
import java.io.*;

import com.example.holubsqlbackend.infrastructure.holub.database.*;
import com.example.holubsqlbackend.infrastructure.holub.database.jdbc.adapters.*;
