...
import java.io.*;
import java.util.*;
import com.example.holubsqlbackend.infrastructure.holub.database.Selector;
...
public interface Table extends Serializable, Cloneable
{
	 ...
	 *  {@link Importer} using the constructor with an
	 *  {@link Importer} argument. The table's
